...
{
	[Serializable]
	public class ProjectedVigor : Effect, ITierInitialized
	{
		public ProjectedVigor()
		{
			base.DisplayName = "Boosted " + Grammar.MakeTitleCase(XRL.World.Statistic.GetStatDisplayName(this.Statistic));
		}

		public ProjectedVigor(int Duration, string Statistic, int Amount)
		{
		...
		{
			return "projected vigor";
		}

		public override string GetDetails()
		{
			return this.Bonus.Signed(false) + " " + "toughness";
		}
		...
		public override bool Apply(GameObject Object)
		{
			...
			{
				ProjectedVigor ProjectedVigor = fx as ProjectedVigor;
				return ProjectedVigor != null;
			});
			//ProjectedVigor ProjectedVigor = Object.GetEffect("ProjectedVigor") as ProjectedVigor;
			if (effect != null)
			{
